...
# -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { Err }]; #IO_L14N_T2_SRCC_14 Sch=led[9]
...
#reset button
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { reset }]; #IO_L3P_T0_DQS_AD1P_15 Sch=cpu_resetn
